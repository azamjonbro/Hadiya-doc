...
/**
 * Homework — distinct from `/assignments`, which is course-to-person
 * assignment, hence the path. The naming collision is inherited from the
 * spec (§6.3) and the three meanings are spelled out in assignment.model.js.
 */
