      ...
      <div class="mt-8">
        ...
        <AppCard v-if="showAddTopic" class="mt-3">
          <form class="grid grid-cols-3 gap-3" @submit.prevent="onAddTopicSubmit">
            <div class="col-span-2"><AppInput v-model="addTopicForm.title" required :label="t('admin.courses.fields.title')" /></div>
          ...
          <AppCard v-for="topic in topics" :key="topic.id">
            <template v-if="editingTopicId === topic.id">
              <div class="grid grid-cols-3 gap-3">
                <div class="col-span-2"><AppInput v-model="editTopicForm.title" :label="t('admin.courses.fields.title')" /></div>
