...
<template>
  ...
  >
    ...
    <div class="border-t border-border p-3">
      ...
      <router-link to="/settings" class="flex items-center gap-2.5 rounded-md px-1.5 py-2 transition-default hover:bg-surface-2" :class="ui.sidebarCollapsed ? 'lg:justify-center' : ''">
